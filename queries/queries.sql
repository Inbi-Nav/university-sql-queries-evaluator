...
SELECT g.nombre AS grau, asig.tipo AS tipus, SUM(asig.creditos) AS total_creditos
FROM grado g
JOIN asignatura asig ON asig.id_grado = g.id
...
SELECT ce.anyo_inicio, COUNT(DISTINCT al.id_alumno) AS total
FROM curso_escolar ce
JOIN alumno_se_matricula_asignatura al ON al.id_curso_escolar = ce.id
